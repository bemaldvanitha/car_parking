...
public class Main {
 ...
 public static ArrayList <vehicals> past_vehi=new ArrayList<>();
    ...
    public static void statstic(){
        //need to develop
        int cur_cout=0,van_cout=0,mot_cout=0;
        String most,less;
        for(int i = 0; i< cur_vehi.size();i++){
            if(cur_vehi.get(i).getClass().getSimpleName().equals("car")){
                cur_cout++;
            }
            else if(cur_vehi.get(i).getClass().getSimpleName().equals("van")){
                van_cout++;
            }
            else {
                mot_cout++;
        ...
        for(int i = 0; i< past_vehi.size();i++){
            if(past_vehi.get(i).getClass().getSimpleName().equals("car")){
                cur_cout++;
            }
            else if(past_vehi.get(i).getClass().getSimpleName().equals("van")){
                van_cout++;
            }
            else {
                mot_cout++;
        ...
        if(cur_cout>van_cout){
            if(cur_cout>mot_cout){
                most="cur";
            }
            else{
                most="moter bike";
